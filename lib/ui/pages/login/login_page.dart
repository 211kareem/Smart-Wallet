...
import 'package:smartwallet/logic/bloc/login_bloc.dart';
...
import 'package:smartwallet/ui/pages/dashboard/dashboard_page.dart';
import 'package:smartwallet/ui/widgets/background_clipper.dart';
import 'package:smartwallet/ui/widgets/custom_floating_action_button.dart';
  ...
  loginHeader() =>
      Column(
        ...
        children: <Widget>[
          ...
          textUnderLine('${Translations.of(context).text("app_name")}', TextDecorationStyle.wavy, Colors.purpleAccent),
          SizedBox(
            height: 20.0,
          )
        ],
